  ...
  while(true)
    {
      ...
      attempts+=1;
      stdout.write(" \nplease choose four digits number :");
      String chooseNumber= stdin.readLineSync()!;
      //conditions if the game is over
      if (chooseNumber == randomNumber)
        {
          print("great guessing You took $attempts attempts");
        ...
        {
          print(" incorrect Number !! make sure you choose 4 digits");
